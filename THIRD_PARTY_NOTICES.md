...
Gondlin is MIT-licensed; see `LICENSE`. Third-party components, datasets, generated fixtures,
...
These assets are not redistributed by Gondlin unless explicitly noted. Users
...
| --- | --- | --- |
| Toy regression CSV/NPY | `NN/Examples/Data/toy_regression.csv`, `NN/Examples/Data/toy_regression_X.npy`, `NN/Examples/Data/toy_regression_y.npy` | Synthetic Gondlin tutorial data, covered by the repository MIT license. |
| Toy CIFAR-10-like NPY | `NN/Examples/Data/toy_cifar10like_X.npy`, `NN/Examples/Data/toy_cifar10like_y.npy` | Synthetic Gondlin fixture generated by `NN/Examples/Data/gen_toy_cifar10like.py`, covered by the repository MIT license. |
...
| --- | --- | --- |
| RL widget logs and policies | `data/rl/*.json` | Produced by `gondlin ppo_gridworld`, `gondlin ppo_cartpole`, and related widget demos. |
| FNO prediction CSV/PNG files | `data/real/fno*/predictions*.csv`, `data/real/fno*/predictions*.png` | Produced by `gondlin fno1d_burgers` and `NN/Examples/Data/plot_fno1d_burgers.py`. |
...
- `Two-Stage_Neural_Controller_Training/`
  - This path is gitignored in Gondlin and is not part of the public library
...
4. Keep generated Gondlin logs, plots, and caches out of source releases.
