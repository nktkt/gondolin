...
//
// Gondolin uses SplitMix64 as a small, reproducible counter-based stream: element `i` is sampled
...
#define GONDOLIN_CUDA_RNG_INLINE __device__ __forceinline__ static
#else
#define GONDOLIN_CUDA_RNG_INLINE static inline
#endif

GONDOLIN_CUDA_RNG_INLINE uint64_t gondolin_splitmix64(uint64_t x) {
...
#undef GONDOLIN_CUDA_RNG_INLINE
