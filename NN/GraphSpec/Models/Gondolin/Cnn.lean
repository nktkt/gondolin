...
/-!
# Gondolin-executable model: CNN

This file provides a small CNN constructor using the Gondolin `Seq` builder.
...
def cnn2
    ...
    _root_.Runtime.Autograd.Gondolin.NN.Seq (Shape.CHW inC inH inW) (Shape.Vec outDim) :=
  ...
  _root_.Runtime.Autograd.Gondolin.NN.seq1
      (_root_.Runtime.Autograd.Gondolin.NN.conv2d
    ...
    >>>
    _root_.Runtime.Autograd.Gondolin.NN.seq1
      (_root_.Runtime.Autograd.Gondolin.NN.maxPool2d
    ...
    >>>
    _root_.Runtime.Autograd.Gondolin.NN.seq1
      (_root_.Runtime.Autograd.Gondolin.NN.flatten (s := Shape.CHW c2 poolH2 poolW2))
    >>>
    _root_.Runtime.Autograd.Gondolin.NN.seq1
      (_root_.Runtime.Autograd.Gondolin.NN.linear featSize outDim (seedW := 4) (seedB := 5))
