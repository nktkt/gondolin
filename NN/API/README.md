...
This directory collects the public API modules for Gondlin. The goal is to give users a small set
...
* `import NN.API.Runtime` when you need the lower level runtime surface (`NN.API.Gondlin.*`).
