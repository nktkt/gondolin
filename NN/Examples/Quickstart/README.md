...
This folder is the starting path for Gondlin. It focuses on core moves rather than the full model zoo. The goal is
...
4. `SimpleMlpTrain.lean`
   Command: `lake exe gondlin quickstart_mlp --steps 200 --dtype float --backend compiled`
