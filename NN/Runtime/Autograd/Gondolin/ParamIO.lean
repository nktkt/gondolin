...
Gondolin examples often want a small "train once, save weights, reload later" workflow.
...
```json
{
  "format": "gondolin_paramlist_bits_v1",
  "params": [
...
def formatTag : String := "gondolin_paramlist_bits_v1"
