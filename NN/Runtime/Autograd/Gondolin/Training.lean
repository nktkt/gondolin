...
/-!
# Gondolin training-loop helpers

This module contains training-loop utilities that need the high-level `Gondolin.Optim` optimizer
...
/--
Train `steps` updates with an arbitrary Gondolin optimizer, cycling through `samples`.
