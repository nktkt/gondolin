...
Users normally don’t import this directly; import `NN.Runtime.Autograd.Gondolin`,
...
/-! ## Batch-first primitives (Gondolin user-facing) -/
...
/-- A Gondolin program is backend-polymorphic: it can run in any `m` that implements `Ops`.
