...
Gondlin examples often want a small "train once, save weights, reload later" workflow.
...
```json
{
  "format": "gondlin_paramlist_bits_v1",
  "params": [
...
def formatTag : String := "gondlin_paramlist_bits_v1"
