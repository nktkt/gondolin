...
Users normally don’t import this directly; import `NN.Runtime.Autograd.Gondlin`,
...
/-! ## Batch-first primitives (Gondlin user-facing) -/
...
/-- A Gondlin program is backend-polymorphic: it can run in any `m` that implements `Ops`.
