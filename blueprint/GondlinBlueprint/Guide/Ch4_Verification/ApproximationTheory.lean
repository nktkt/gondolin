...
The word "approximation" appears in several places in Gondlin, and the meanings are different.
...
The [universal approximation API](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/Approximation/Universal/UniversalApproximation.lean)
contains the real valued statement `relu_universal_approximation_Icc`. The rate file
[universal approximation with rates](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/Approximation/Universal/UniversalApproximationRate.lean)
...
[universal approximation in higher dimension](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/Approximation/Universal/UniversalApproximationND.lean)
...
For example, the [IEEE32Exec approximation API](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/Approximation/Universal/UniversalApproximationIEEE32Exec.lean)
...
[float interval semantics API](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/Approximation/FloatInterval/Semantics.lean),
...
[exact image theorem API](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/Approximation/FloatInterval/ExactImageTheorem.lean)
...
[constant target example](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/Approximation/FloatInterval/ConstantTarget.lean)
...
Gondlin uses "approximation" in at least three different ways:
