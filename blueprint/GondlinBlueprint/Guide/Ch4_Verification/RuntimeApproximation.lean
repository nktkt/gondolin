...
sentence in mind. Gondlin does not allow that step to be implicit: a real valued safety theorem
...
Gondlin's answer is to name the bridge:
...
[runtime approximation core](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Core.lean),
[spec approximation](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Core/SpecApprox.lean), and
[tolerances](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Core/Tolerance.lean).
...
Gondlin uses both styles, but it makes the choice explicit instead of burying it in test
thresholds.

# Forward Graph Approximation

The forward graph theorem is in
[NN.Proofs.RuntimeApprox.Graph.ForwardApprox API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Graph/ForwardApprox.lean).
...
[backward approximation API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Graph/BackwardApprox.lean).
...
The bridge file
[NN.Proofs.RuntimeApprox.Graph.LinkAutogradAlgebra API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Graph/LinkAutogradAlgebra.lean)
...
This claim needs careful wording. Gondlin does not collapse "correct gradient" and
...
[NN.Proofs.RuntimeApprox.NF.Ops API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/NF/Ops.lean). `NF` is
Gondlin's rounded real neural float model. It gives proof side arithmetic that resembles finite
...
with respect to inputs and parameters. Gondlin has dedicated normal form APIs:

- [NN.Proofs.RuntimeApprox.NF.ConvForward API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/NF/ConvForward.lean)
- [NN.Proofs.RuntimeApprox.NF.ConvBackward API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/NF/ConvBackward.lean)
- [NN.Proofs.RuntimeApprox.NF.Conv API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/NF/Conv.lean)
...
[scale bounds](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Scale.lean),
[scale approximation](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Scale/ScaleApprox.lean),
[forward scale propagation](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Scale/ForwardScale.lean), and
[backward scale propagation](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Scale/BackwardScale.lean).
...
The [FP32 layer approximation API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/FP32/Layers.lean),
[FP32 MLP approximation API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/FP32/MLP.lean), and
[FP32 CROWN bridge API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/FP32/CROWN.lean) connect the approximation
...
Only after that bridge do we get a classification claim about runtime behavior. This is why Gondlin
...
1. Read the [tolerance API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Core/Tolerance.lean) and
   [spec approximation API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Core/SpecApprox.lean) for the relation.
2. Read the [forward graph approximation API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Graph/ForwardApprox.lean) and find
   `FwdGraph.eval_approx`.
3. Read the [backward graph approximation API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Graph/BackwardApprox.lean) and
   find `RevGraph.backprop_approx`.
4. Read one local op family in the [normal form operator API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/NF/Ops.lean), especially
   a domain sensitive one such as division or safe log.
5. Read the [convolution forward API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/NF/ConvForward.lean) and
   [convolution backward API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/NF/ConvBackward.lean) for a larger operator.
6. Read the [scale approximation API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Scale/ScaleApprox.lean) when absolute
   tolerances are too coarse.
7. Read the [autograd algebra link API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/RuntimeApprox/Graph/LinkAutogradAlgebra.lean)
...
This is the intended Gondlin shape: fast code and imported artifacts are allowed, while the
