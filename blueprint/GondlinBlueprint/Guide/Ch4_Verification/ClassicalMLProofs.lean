...
Not every proof in Gondlin is about a modern runtime boundary. Some declarations formalize
classical ML theory: Hopfield energy, ReLU approximation components, and state space scan
or causality facts. These are valuable because they show Gondlin can host mathematical ML theory
...
[Hopfield energy API](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/Hopfield/Energy.lean):
...
The [ReLU multiplication approximation API](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/ReLU/Approx/ReLUMulApprox.lean)
records a small network shaped approximation component for multiplication. The
[compact set approximation API](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/ReLU/Approximation/CompactSet.lean) gives
the language for approximation on compact domains. The
[ReLU MLP bridge API](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/ReLU/Bridge/ReLUMlpBridge.lean) connects those pieces
...
The [state space scan API](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/StateSpace/Scan.lean) proves append theorems for
...
The [Mamba causality API](https://github.com/nktkt/gondlin/blob/main/NN/MLTheory/Proofs/StateSpace/MambaCausality.lean) specializes that
