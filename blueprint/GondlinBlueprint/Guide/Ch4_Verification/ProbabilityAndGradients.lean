...
The [diffusion probability API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/Probability/DiffusionForward.lean) states the
...
The [linear gradient API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/Gradients/Linear.lean) records the three derivative
...
The [activation gradient API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/Gradients/Activation.lean) does the same for scalar
...
That distinction matters. Gondlin does not need one proof style for every gradient claim. A
