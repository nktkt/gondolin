...
Once tensors have shapes, a model can be read as a typed map between tensor spaces. Gondlin's
...
[NN.Examples.Quickstart.SimpleMlpTrain](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Quickstart/SimpleMlpTrain.lean).
...
intuition that `Linear(inDim, outDim)` can be applied to inputs shaped `[..., inDim]`. Gondlin asks
...
[NN.Examples.Quickstart.MinibatchMlpTrain](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Quickstart/MinibatchMlpTrain.lean).
...
[NN.Examples.Quickstart.SimpleCnnTrain](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Quickstart/SimpleCnnTrain.lean).
...
[NN.Examples.Quickstart.ResnetBasicblockTrain](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Quickstart/ResnetBasicblockTrain.lean).
The larger model wrappers live under [NN/API/Models/Resnet.lean](https://github.com/nktkt/gondlin/blob/main/NN/API/Models/Resnet.lean).
...
- and model wrappers under [NN/API/Models/Transformer.lean](https://github.com/nktkt/gondlin/blob/main/NN/API/Models/Transformer.lean),
  [NN/API/Models/Gpt2.lean](https://github.com/nktkt/gondlin/blob/main/NN/API/Models/Gpt2.lean), and
  [NN/API/Models/Vit.lean](https://github.com/nktkt/gondlin/blob/main/NN/API/Models/Vit.lean).
...
PyTorch stores parameters inside module objects. Gondlin keeps the parameter bundle explicit. That
