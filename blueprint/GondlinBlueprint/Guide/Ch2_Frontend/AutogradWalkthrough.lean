...
Most ML users first meet automatic differentiation through `loss.backward()`. Gondlin keeps that
...
Gondlin keeps both results ordinary values. There is no hidden `.grad` field that must be cleared
...
This is one of the places where Gondlin's shape discipline pays off. The type of the derivative
...
Those declarations live in [NN.API.Public](https://github.com/nktkt/gondlin/blob/main/NN/API/Public.lean), while the lower runtime
implementation lives in [NN.API.Runtime](https://github.com/nktkt/gondlin/blob/main/NN/API/Runtime.lean) and
[NN.Runtime.Autograd.Gondlin.Autodiff](https://github.com/nktkt/gondlin/blob/main/NN/Runtime/Autograd/Gondlin/Autodiff.lean).

# Jacobians, JVPs, And HVPs

Gondlin also exposes analysis tools beyond the basic training gradient:
...
- [NN.Proofs.Autograd.Overview API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/Autograd/Overview.lean)
...
- [NN.Proofs.Autograd.Runtime.Link API](https://github.com/nktkt/gondlin/blob/main/NN/Proofs/Autograd/Runtime/Link.lean)
...
[NN.Examples.Quickstart.AutogradBasics](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Quickstart/AutogradBasics.lean). It prints
