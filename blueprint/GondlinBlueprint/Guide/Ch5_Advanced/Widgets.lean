...
Widgets are the human inspection layer of Gondlin. They do not define semantics and they do not
...
The [widgets API](https://github.com/nktkt/gondlin/tree/main/NN/Widgets/) is collected by `NN.Entrypoint.Widgets`. Import that entrypoint
...
Widgets are a debugging UI, not a proof system. Gondlin keeps the meaning of "execute this"
explicit:
...
Gondlin's verification stack includes executable bound propagation engines (IBP and CROWN
...
Gondlin's eager autograd engine records a computation graph into a `Tape` and can run
...
Gondlin's widget layer is not limited to semantic objects like tensors and tapes. It also
...
- [tensor basics example API](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Quickstart/TensorBasics.lean)
- [widgets example](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Advanced/Widgets.lean)
...
- [widgets example](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Advanced/Widgets.lean)
- [Gondlin IBP fixture API](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Verification/Gondlin/GondlinIBP.lean)
...
- [widgets example](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Advanced/Widgets.lean)
- [Gondlin Transformer IBP fixture API](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Verification/Gondlin/GondlinTransformerIBP.lean)
...
- [widgets demo](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Advanced/Widgets.lean)
- [float32 modes demo](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Advanced/Floats/Float32Modes.lean)
...
- [CROWN ops fixture](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Verification/Gondlin/GondlinCrownOps.lean)
- [IBP fixture](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Verification/Gondlin/GondlinIBP.lean)
...
- [autograd basics](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Quickstart/AutogradBasics.lean)
- [widgets demo](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Advanced/Widgets.lean)
...
- [widgets demo](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Advanced/Widgets.lean)
- [CSV loader demo](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Data/Loaders/Csv.lean)
- [ResNet basic block training](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Quickstart/ResnetBasicblockTrain.lean)
...
- [widgets demo](https://github.com/nktkt/gondlin/blob/main/NN/Examples/Advanced/Widgets.lean)
- [runtime context API](https://github.com/nktkt/gondlin/blob/main/NN/Runtime/Context.lean)
