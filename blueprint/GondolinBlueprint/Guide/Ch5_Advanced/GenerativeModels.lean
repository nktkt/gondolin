...
Gondolin separates the runnable examples from the formal statements. The
[generative model examples](https://github.com/nktkt/gondolin/tree/main/NN/Examples/Models/Generative/) show that the Gondolin API and
runtime can train compact programs shaped like diffusion models, autoencoders, VAEs, VQ-VAEs, and
GANs. The [generative theory API](https://github.com/nktkt/gondolin/tree/main/NN/MLTheory/Generative/) records the pieces we can presently
...
- *Diffusion*: the [diffusion command](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Generative/Diffusion.lean) has
...
- *VAE*: the [compact VAE example](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Generative/Vae.lean) runs over flattened
  image tensors; the theory side records ELBO algebra, beta weighting, and diagonal Gaussian KL
  nonnegativity.
- *VQ-VAE*: the [VQ-VAE example](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Generative/VqVae.lean) gives a
  reconstruction path; the theory side records codebook loss decomposition and nearest-code facts.
- *GAN / LSGAN*: the [GAN warmup](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Generative/Gan.lean) runs a small
  generator/discriminator objective; the theory side packages generator and discriminator losses.
- *Autoencoder / MAE*: the [autoencoder](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Generative/Autoencoder.lean) and
  [masked autoencoder](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Generative/Mae.lean) demos connect to reconstruction
...
the [diffusion example API](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Generative/Diffusion.lean), and the API model
constructor is in [NN.API.Models.Diffusion API](https://github.com/nktkt/gondolin/blob/main/NN/API/Models/Diffusion.lean). The example
...
- The [forward Gaussian API](https://github.com/nktkt/gondolin/blob/main/NN/MLTheory/Generative/Diffusion/ForwardGaussian.lean) defines
...
- The [diffusion samplers API](https://github.com/nktkt/gondolin/blob/main/NN/MLTheory/Generative/Diffusion/Samplers.lean) states base case identities
...
[NN.Examples.Models.Generative.Vae API](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Generative/Vae.lean), the model
...
path through the Gondolin model API; it is not a full stochastic variational inference experiment.

The proof statements are sharper:

- [NN.Spec.Models.Vae API](https://github.com/nktkt/gondolin/blob/main/NN/Spec/Models/Vae.lean) names the VAE forward pass and loss shape.
- [NN.MLTheory.Generative.Latent.VAE API](https://github.com/nktkt/gondolin/blob/main/NN/MLTheory/Generative/Latent/VAE.lean) proves
...
[NN.Examples.Models.Generative.VqVae API](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Generative/VqVae.lean), uses a
...
- [NN.Spec.Models.VqVae API](https://github.com/nktkt/gondolin/blob/main/NN/Spec/Models/VqVae.lean), which states quantization and loss
  equations for a codebook model.
- [NN.MLTheory.Generative.Latent.VQVAE API](https://github.com/nktkt/gondolin/blob/main/NN/MLTheory/Generative/Latent/VQVAE.lean), which
...
Here again, the boundary is precise. The runnable example exercises Gondolin's training surface for
...
[NN.Examples.Models.Generative.Gan API](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Generative/Gan.lean) is a small
...
- [NN.Spec.Models.Gan API](https://github.com/nktkt/gondolin/blob/main/NN/Spec/Models/Gan.lean), which names generation, fake scores, and
  discriminator losses.
- [NN.MLTheory.Generative.Latent.GAN API](https://github.com/nktkt/gondolin/blob/main/NN/MLTheory/Generative/Latent/GAN.lean), which
...
This gives us a clean citation line: Gondolin contains checked algebra for LSGAN style scalar
...
[the autoencoder example API](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Generative/Autoencoder.lean) is the simplest
...
The masked autoencoder in [the MAE example API](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Generative/Mae.lean) is more
...
- For a command that trains or samples through Gondolin, cite the corresponding file in
...
the discipline: Gondolin can run programs shaped like ML systems, and we can grow the formal
