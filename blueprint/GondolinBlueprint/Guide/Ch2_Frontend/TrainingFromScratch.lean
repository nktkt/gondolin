...
A Gondolin training file usually has five blocks: constants, model, task, data, and fit/report.
...
- [NN.Examples.Quickstart.SimpleMlpTrain API](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Quickstart/SimpleMlpTrain.lean)
- [NN.Examples.Quickstart.SimpleCnnTrain API](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Quickstart/SimpleCnnTrain.lean)
- [NN.Examples.Quickstart.ResnetBasicblockTrain API](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Quickstart/ResnetBasicblockTrain.lean)
- [NN.Examples.Quickstart.AutogradBasics API](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Quickstart/AutogradBasics.lean)
...
The PyTorch training pattern and the Gondolin training pattern are intentionally close:
...
Gondolin writes the same structure in Lean, but makes the parameter bundle explicit:
...
Gondolin's difference is where the state lives. Parameters, optimizer state, runtime mode, and logs
...
- [CSV loader example](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Data/Loaders/Csv.lean)
- [NPY loader example](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Data/Loaders/Npy.lean)
- [CIFAR image loader example](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Data/Loaders/Cifar10Images.lean)
...
Gondolin’s differentiation is functional: tensors do not carry mutable `.grad` fields. Instead,
Gondolin provides `autograd` primitives that transform functions.
...
- [Float32 modes example](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Advanced/Floats/Float32Modes.lean)
- [NN.Examples.Quickstart.SimpleMlpTrain API](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Quickstart/SimpleMlpTrain.lean)
...
Gondolin’s equivalent is the same loop shape, but the gradients and the model state are explicit in
the API:
...
That correspondence is deliberate. Gondolin keeps the training rhythm familiar while making the
...
Gondolin supports fully in-memory datasets (TensorDataset-style), plus typed minibatching.

Examples:

- [NN.Examples.Quickstart.MinibatchMlpTrain API](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Quickstart/MinibatchMlpTrain.lean)
- [CSV loader example](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Data/Loaders/Csv.lean)
- [NPY loader example](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Data/Loaders/Npy.lean)

For the data boundary contract (`.npy`, small numeric CSV, UTF-8 text), see:

- [NN/API/Data/README.md](https://github.com/nktkt/gondolin/blob/main/NN/API/Data/README.md)
- [NN/Examples/Data/README.md](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Data/README.md)
