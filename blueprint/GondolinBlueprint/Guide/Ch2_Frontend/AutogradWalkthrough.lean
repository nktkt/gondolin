...
Most ML users first meet automatic differentiation through `loss.backward()`. Gondolin keeps that
...
Gondolin keeps both results ordinary values. There is no hidden `.grad` field that must be cleared
...
This is one of the places where Gondolin's shape discipline pays off. The type of the derivative
...
Those declarations live in [NN.API.Public](https://github.com/nktkt/gondolin/blob/main/NN/API/Public.lean), while the lower runtime
implementation lives in [NN.API.Runtime](https://github.com/nktkt/gondolin/blob/main/NN/API/Runtime.lean) and
[NN.Runtime.Autograd.Gondolin.Autodiff](https://github.com/nktkt/gondolin/blob/main/NN/Runtime/Autograd/Gondolin/Autodiff.lean).

# Jacobians, JVPs, And HVPs

Gondolin also exposes analysis tools beyond the basic training gradient:
...
- [NN.Proofs.Autograd.Overview API](https://github.com/nktkt/gondolin/blob/main/NN/Proofs/Autograd/Overview.lean)
...
- [NN.Proofs.Autograd.Runtime.Link API](https://github.com/nktkt/gondolin/blob/main/NN/Proofs/Autograd/Runtime/Link.lean)
...
[NN.Examples.Quickstart.AutogradBasics](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Quickstart/AutogradBasics.lean). It prints
