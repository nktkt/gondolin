...
explains how data enters Gondolin: as in-memory samples, file-backed tensors, deterministic
...
Gondolin packages that idea with the public `Data` and `sample` namespaces. In the MLP quickstart,
...
This is the Gondolin analogue of a small PyTorch `TensorDataset`: a finite dataset whose elements
...
[NN.API.Samples.Bands](https://github.com/nktkt/gondolin/blob/main/NN/API/Samples/Bands.lean).

# File Sources

For real data, Gondolin uses small, predictable file contracts:
...
Gondolin, the batch dimension can appear in the type. If the model is written for
...
Good examples should show training progress. Gondolin uses callbacks for that:
...
- [NN/API/Text.lean](https://github.com/nktkt/gondolin/blob/main/NN/API/Text.lean)
- [NN/Examples/Models/Sequence/Transformer.lean](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Sequence/Transformer.lean)
- [NN/Examples/Models/Sequence/TextGpt2.lean](https://github.com/nktkt/gondolin/blob/main/NN/Examples/Models/Sequence/TextGpt2.lean)
