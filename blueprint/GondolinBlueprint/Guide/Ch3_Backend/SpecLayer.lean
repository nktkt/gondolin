...
The spec layer is where Gondolin says what a model means before asking how it runs. A dense layer
...
Gondolin is written in Lean, which is both a programming language and an interactive theorem
...
the objective. Gondolin keeps losses in the spec vocabulary too.
...
Most Gondolin spec definitions are scalar-polymorphic: they work for any scalar type `α` that
...
in [NN.Spec.Core.Context API](https://github.com/nktkt/gondolin/blob/main/NN/Spec/Core/Context.lean).
...
This is the smallest useful instance of Gondolin's "write the architecture once; choose the scalar
...
- [Context API](https://github.com/nktkt/gondolin/blob/main/NN/Spec/Core/Context.lean), for the scalar operations a spec may use,
- [Linear layers API](https://github.com/nktkt/gondolin/blob/main/NN/Spec/Layers/Linear.lean), for dense layer semantics,
- [Activation API](https://github.com/nktkt/gondolin/blob/main/NN/Spec/Layers/Activation.lean), for ReLU, sigmoid, tanh, GELU, and related
  operations,
- [Loss API](https://github.com/nktkt/gondolin/blob/main/NN/Spec/Layers/Loss.lean), for scalar objectives used by examples and training
  loops,
- [Dropout API](https://github.com/nktkt/gondolin/blob/main/NN/Spec/Layers/Dropout.lean), for the explicit training/inference split.
...
The [model spec API](https://github.com/nktkt/gondolin/tree/main/NN/Spec/Models/) contains denotations for larger architecture families:
...
semantics and executable Gondolin programs. Read *Verification* for how bounds and certificates
refer back to the same denotation.

For concrete declarations, start with the [Context API](https://github.com/nktkt/gondolin/blob/main/NN/Spec/Core/Context.lean), then the
[layer semantics API](https://github.com/nktkt/gondolin/tree/main/NN/Spec/Layers/), the [model spec API](https://github.com/nktkt/gondolin/tree/main/NN/Spec/Models/), and the
[autograd spec API](https://github.com/nktkt/gondolin/tree/main/NN/Spec/Autograd/).
