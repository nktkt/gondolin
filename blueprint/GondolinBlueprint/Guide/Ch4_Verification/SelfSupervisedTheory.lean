...
Gondolin's SSL layer is about these objective semantics. It does not prove that MAE, JEPA, or
...
The [predictive view API](https://github.com/nktkt/gondolin/blob/main/NN/MLTheory/SelfSupervised/PredictiveView.lean) packages that
...
Masks are equally concrete. The [masking API](https://github.com/nktkt/gondolin/blob/main/NN/MLTheory/SelfSupervised/Masking.lean)
...
The [MAE API](https://github.com/nktkt/gondolin/blob/main/NN/MLTheory/SelfSupervised/MAE.lean) starts with a patch batch, represented as a
...
The [JEPA API](https://github.com/nktkt/gondolin/blob/main/NN/MLTheory/SelfSupervised/JEPA.lean) keeps `encodeContext`, `encodeTarget`,
...
The [VICReg API](https://github.com/nktkt/gondolin/blob/main/NN/MLTheory/SelfSupervised/VICReg.lean) names the three pressure terms that
...
Gondolin formalizes selected SSL objective components and finite mask/list properties. It does not
