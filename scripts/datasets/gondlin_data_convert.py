#!/usr/bin/env python3
"""Convert common dataset artifacts into Gondlin's canonical tensor files.

Gondlin's Lean-side loaders stay small and deterministic:
...
That keeps Gondlin examples and training code simple:

    python3 scripts/datasets/gondlin_data_convert.py tensor --input data.pt --key x --output X.npy
    lake exe gondlin cnn --cuda --x X.npy --y y.npy --n-total 1000
"""
