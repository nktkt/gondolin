#!/usr/bin/env python3
"""Convert common dataset artifacts into Gondolin's canonical tensor files.

Gondolin's Lean-side loaders stay small and deterministic:
...
That keeps Gondolin examples and training code simple:

    python3 scripts/datasets/gondolin_data_convert.py tensor --input data.pt --key x --output X.npy
    lake exe gondolin cnn --cuda --x X.npy --y y.npy --n-total 1000
"""
